    ...
    <div className="website-container">
      ...
      <main className="fake-api-container">
        ...
        <section className="create-api-section">
          ...
          <p>
            The editor below allows you to create a fake JSON API with your own
            fake data. Scroll down for ready-to-use examples of different fake
            APIs.
          </p>
        </section>
        ...
        <section className="mocki-section">
          ...
          <p className="api-description">
            ...
            dynamic responses, and more advanced features, you can use Mocki. We
            created the tool to make development and testing APIs a lot easier.
          </p>

          <p className="api-description">
            If you, for example, wanted to mock the endpoints provided above in
            a single API, it would require the following endpoints:
          </p>
        </section>
      </main>
    </div>
